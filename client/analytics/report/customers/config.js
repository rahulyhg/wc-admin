	...
	filters: {
		...
		registered: {
			...
			rules: [
				...
				{
					value: 'after',
					/* translators: Sentence fragment, logical, "Excludes" refers to customers registered after a given date. Screenshot for context: https://cloudup.com/cCsm3GeXJbE */
					label: _x( 'After', 'date', 'wc-admin' ),
				},
				{
					value: 'between',
					/* translators: Sentence fragment, logical, "Excludes" refers to customers registered between given dates. Screenshot for context: https://cloudup.com/cCsm3GeXJbE */
